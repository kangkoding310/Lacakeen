...
<template>
    <Teleport to="body">
        ...
        >
            <div
                v-if="open"
                class="fixed inset-0 z-[100] grid place-items-center overflow-y-auto bg-slate-950/45 p-4 backdrop-blur-sm"
            ...
            >
                ...
                >
                    <section
                        class="my-6 w-full rounded-2xl border border-white/60 bg-white shadow-2xl"
