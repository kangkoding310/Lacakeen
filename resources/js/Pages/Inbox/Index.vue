...
<template>
    <Head title="Inbox" />
    <AppLayout title="Inbox" section="Tools"
        ><div class="page-shell max-w-6xl">
            <div>
                <h1 class="text-2xl font-bold">Inbox</h1>
                <p class="mt-1 text-sm text-slate-500">
                    Mentions, assignments, and requests in one actionable list.
                </p>
            </div>
            <div class="mt-6 grid gap-4 lg:grid-cols-[220px_1fr]">
                ...
                <div
                    ...
                    class="ui-card divide-y divide-slate-100 overflow-hidden"
                >
                    <Link
                ...
                <EmptyState v-else title="Inbox zero" description="No items match this filter." />
            </div></div
    ></AppLayout>
</template>
