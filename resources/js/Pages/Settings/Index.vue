...
const preferences = useForm({
    email_task_assigned:
        settingsUser.value.notification_preferences?.email_task_assigned ??
        true,
    email_due_reminder:
        settingsUser.value.notification_preferences?.email_due_reminder ?? true,
    push_comments:
        settingsUser.value.notification_preferences?.push_comments ?? true,
});
                ...
                <section class="ui-card p-5 sm:p-7">
                    ...
                    >
                        ...
                        <div class="flex items-center gap-4">
                            <img
                                :src="settingsUser.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(profile.name)}`"
                    ...
                    <form
                        ...
                        class="max-w-2xl space-y-5"
                        @submit.prevent="
                            workspaceForm.patch(route('settings.workspace'))
                        "
                    >
                        <div>
                    ...
                    <form
                        ...
                        class="max-w-2xl"
                        @submit.prevent="
                            preferences.patch(route('settings.preferences'))
                        "
                    >
                        ...
                        <button class="ui-button-primary mt-5">
                            Save preferences
                        </button>
                    </form>
                    <div v-else-if="tab === 'billing'" class="max-w-2xl">
                        ...
                        <p class="text-sm text-slate-400">
                            Your current workspace subscription.
                        </p>
                        <div
                        ...
                        >
                            <div class="flex justify-between">
                                <span
                                    class="rounded-lg bg-white/10 px-2 py-1 text-xs font-bold"
                                    >PRO</span
                                >
                            ...
                            <p class="mt-2 text-sm text-slate-300">
                                Unlimited projects, automations, reporting, and
                                priority support.
                            </p>
                    ...
                    <div v-else class="max-w-2xl">
                        ...
                        >
                            ...
                            >
                                <KeyRound class="h-4 w-4 text-blue-600" />Change
                                password
                            </h3>
                            <div>
                        ...
                        <div
                            class="mt-4 rounded-xl border border-slate-200 p-5"
                        >
